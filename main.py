...
maze_path = "maze11x11.png" # The maze path
...
out = cv2.VideoWriter(maze_path.split('.')[0] + "_solved_" + format(datetime.datetime.now().strftime("%H_%M_%S")) + "_" + str(execution_time) + ".avi", cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), 15, size)
